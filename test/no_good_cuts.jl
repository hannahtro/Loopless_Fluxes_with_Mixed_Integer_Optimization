...
@testset "simple model" begin
    ...
    @show solution 
    @show SCIP.sol_values(ch.o, vcat(ch.vars, ch.binvars))
    @test isapprox(objective_value,objective_value_fast)
...
#     scip_model, bin_vars, flux_vars = build_fba_indicator_model_moi(S, lb, ub, internal_rxn_idxs, set_objective=true, time_limit=20, objective_func_vars=objective_func_vars, objective_func_coeffs=objective_func.terms.vals)
#     # print(scip_model)
