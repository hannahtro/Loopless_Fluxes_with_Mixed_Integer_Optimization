...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State $\mathcal{C} \gets \text{compute\_mis}(\bold S_\mathcal{I}, \bold a, m)$ \Comment{set of minimal infeasible subsystems}
        ...
        \While{$\mathcal{C} \neq \emptyset$}
            \State $\text{add\_cut}(\text{MP}, \bold a, \mathcal{C})$ \Comment{combinatorial Benders' cut}
