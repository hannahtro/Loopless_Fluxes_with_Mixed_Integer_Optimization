...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{\label[apptab]{tab:ll_fba_comparison} \small Results of solving \textsf{ll-FBA (big-M)} and \textsf{ll-FBA (nullspace)} directly with \textsf{SCIP}.}
\end{table}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        Recon3D & TIME\_LIMIT & 1800 & - & TIME\_LIMIT & 1800 & - \\ \hline
    \end{tabular}
    \caption{\label[apptab]{tab:ll_fba_indicator} \small Results of solving \textsf{ll-FBA (big-M)} and \textsf{ll-FBA (indicator)} directly with \textsf{SCIP}.}
\end{table}
...
\begin{table}[!ht]
    ...
    \begin{tabular}{lrr}
    \hline
        \textbf{model} & \textbf{time (s)} & \textbf{cycles} \\ \hline
    ...
    \end{tabular}
    \caption{\label[apptab]{tab:cff_time} \small The running time and the number of detected cycles by using the CycleFreeFlux algorithm on a subset of BiGG models.}
\end{table}
...
\begin{table}[!ht]
    ...
    \cline{2-3} \cline{4-5} 
        ...
        Recon3D & TIME\_LIMIT & 1800 & TIME\_LIMIT & 1800 \\ \hline
    \end{tabular}
    \caption{\label[apptab]{tab:no_good_cuts} \small Results of solving \textsf{ll-FBA (big-M)} directly and of solving the decomposition with no-good cuts.}
\end{table}
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{\label[apptab]{tab:cb_mp_variants} \small Results of solving the \textsf{ll-FBA} with combinatorial Benders' cuts for different formulations of the master problem. We add one cut per iteration of \cref{alg:CB}.}
\end{table}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{model} & \textbf{termination} & \textbf{time} & \textbf{termination} & \textbf{time} & \textbf{termination} & \textbf{time} \\ \hline
    ...
    \end{tabular}
    \caption{\label[apptab]{Tab:ch_vs_cb} \small Results of solving \textsf{ll-FBA} with the combinatorial Benders' approach in \textsf{JuMP} (\textbf{CB (big-M)}) compared to integrating the Combinatorial Benders' decomposition in a constraint handler in \textsf{SCIP} directly (\textbf{CH}).}
\end{table}
