...
#     molecular_model = load_model("../molecular_models/mat/" * organism * ".mat")
...
# @show organism_data[1:num]
# min_m = organism_data[1:num]
...
# @show organism_data[1:num]
# min_sum = organism_data[1:num]
# println("")

# @show unique(vcat(min_m, min_r, min_sum))
# smallest_organisms = [i[1] for i in unique(vcat(min_m, min_r, min_sum))]
# smallest_organisms = smallest_organisms[1:num]
# writedlm("ecModel_small_model_names_ " * string(num) * ".txt", smallest_organisms)
