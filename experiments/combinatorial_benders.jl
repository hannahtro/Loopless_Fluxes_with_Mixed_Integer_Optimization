...
type = "cb_fast_big_m"
try 
    combinatorial_benders_data(organism, time_limit=time_limit, fast=fast, json=json, yeast=yeast, indicator=true, big_m=false, multiple_mis=mis, set_maxorigsol=true)
catch e 
    println(e)
