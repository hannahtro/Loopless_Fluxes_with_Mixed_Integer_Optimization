...
type = "cb_fast_big_m"
try 
    combinatorial_benders_data(organism, time_limit=time_limit, fast=fast, json=json, yeast=yeast, indicator=false, big_m=true, multiple_mis=mis, max_density=max_density)
catch e 
    println(e)
